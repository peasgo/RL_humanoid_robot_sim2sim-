...
from .newproject_marl_env_cfg import NewprojectMarlEnvCfg


class NewprojectMarlEnv(DirectMARLEnv):
    cfg: NewprojectMarlEnvCfg

    def __init__(self, cfg: NewprojectMarlEnvCfg, render_mode: str | None = None, **kwargs):
