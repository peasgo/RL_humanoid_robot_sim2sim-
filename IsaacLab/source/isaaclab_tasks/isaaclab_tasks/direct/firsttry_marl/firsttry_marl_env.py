...
from .firsttry_marl_env_cfg import FirsttryMarlEnvCfg


class FirsttryMarlEnv(DirectMARLEnv):
    cfg: FirsttryMarlEnvCfg

    def __init__(self, cfg: FirsttryMarlEnvCfg, render_mode: str | None = None, **kwargs):
